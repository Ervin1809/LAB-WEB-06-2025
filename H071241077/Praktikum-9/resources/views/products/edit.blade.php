  ...
  <form action="{{ route('products.update',$product) }}" method="post">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-3"><label class="form-label">Harga</label>
        <input name="price" type="number" step="0.01" class="form-control" value="{{ old('price',$product->price) }}" required></div>
      ...
      <div class="col-md-4 mb-3"><label class="form-label">Berat (kg)</label>
        <input name="weight" type="number" step="0.01" class="form-control" value="{{ old('weight',$product->detail->weight ?? '') }}" required></div>

      <div class="col-md-4 mb-3"><label class="form-label">Size</label>
        <input name="size" class="form-control" value="{{ old('size',$product->detail->size ?? '') }}"></div>
    </div>
