...
@section('title', 'Edit Ikan - Fish It Roblox')
                ...
                <form action="{{ route('fishes.update', $fish) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="4" 
                                  placeholder="Deskripsi ikan (opsional)...">{{ old('description', $fish->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-warning">
                            <i class="bi bi-save"></i> Update Ikan
                        </button>
                        <a href="{{ route('fishes.show', $fish) }}" class="btn btn-info">
